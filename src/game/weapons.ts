...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  ...
  smoke:    { id:"smoke",    name:"Smoke",    kind:"thrown", class:"misc",   dmg:0,   fireCd:0.80, spread:0,    pellets:0, speed:300, ammoPerShot:0, pierce:99, color:"#cfcfcf", desc:"Vision-blocking smoke (charge throw)." },
