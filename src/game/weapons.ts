...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  ...
  sniper: { id:"sniper", name:"Sniper", kind:"ranged", class:"ranged", dmg:100, fireCd:0.65, spread:0, pellets:1, speed:1600, ammoPerShot:1, pierce:2, color:"#111111", visual:"long black stick", desc:"100 DMG, 2 pierce, fast long-range projectile." },
  ...
  flamethrower: { id:"flamethrower", name:"Flamethrower", kind:"ranged", class:"ranged", dmg:9, fireCd:0.05, spread:0.18, pellets:1, speed:420, ammoPerShot:1, pierce:0, color:"#ff6a00", visual:"orange tank on back, orange hose in hand", desc:"Continuous stream applying Fire." },
  gold_machine_gun: { id:"gold_machine_gun", name:"Gold Machine Gun", kind:"ranged", class:"ranged", dmg:8, fireCd:0.01, spread:0.09, pellets:1, speed:980, ammoPerShot:1, pierce:0, color:"#ffd84a", visual:"golden machine gun", desc:"VERY VERY fast fire rate. 8 DMG per hit." },
