...
export const MAIN_SHOP: ShopItem[] = [
  ...
  { id:"buy_yamato", name:"Yamato", cost:8500, currency:"coins", category:"melee", weapon:"yamato", limit:1, color:"#b9e6ff", visual:"Japanese Katana", desc:"Glint animation. Suspends enemies for combo attacks. 60 DMG." },
  { id:"buy_gauntlet", name:"Gauntlet", cost:7500, currency:"coins", category:"melee", weapon:"gauntlet", limit:1, color:"#9ca3af", visual:"2 gray gloves", desc:"Punching animation. Knocks enemies back. Triple-press J grants extra dash. 70 DMG." },
  ...
  { id:"buy_lightrod", name:"Lightning Rod", cost:2500, currency:"coins", category:"misc", weapon:"lightning_rod", limit:10, color:"#7be0ff", visual:"Tesla stick", desc:"Place on ground. Continuous lightning. Chains with other rods. 15 DMG per 0.89s." },
  { id:"buy_disco", name:"Disco Bomb", cost:3500, currency:"coins", category:"misc", weapon:"disco_bomb", limit:10, color:"#ff4fd8", visual:"Multicolored ball", desc:"Enemies jump dance and cannot attack for 6s." },
